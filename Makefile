...
# Input Names
CUDA_FILES = src/spectral_partition.cu
CPP_FILES = src/spectral_partition.cpp src/ta_utilities.cpp
...
LIBS = -L$(CUDA_LIB_PATH) -lcudart -lcublas -lsndfile -lcusolver
...
# Top level rules
all: spectral_partition

spectral_partition: $(OBJ_CPU) $(CUDA_OBJ) $(CUDA_OBJ_FILES)
